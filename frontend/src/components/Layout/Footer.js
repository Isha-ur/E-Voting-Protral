...
const Footer = () => {
  return (
    <footer
      className=" bg-gray-900  m-top-8 p-4  sm:p-6  bottom-0 left-0 right-0"
      style={{ marginTop: "20px", backgroundColor: "#172837" }}
    >
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <NavLink className="flex items-center">
              <img
                src="https://nriol.com/images/india_state_map.png"
                className="mr-3 h-8"
                alt="FlowBite Logo"
              />
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center text-gray-400">
            © 2022{" "}
            <NavLink
              href="https://nriol.com/images/india_state_map.png"
              className="hover:underline"
            >
              INDIA™
            </NavLink>
